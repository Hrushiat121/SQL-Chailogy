# SQL Chaichology
SQL Chaichology is a data analytics project built to analyze sales and customer behavior across chai outlets. Using joins, CTEs, window functions, and aggregations, it identifies best-selling items, peak hours, repeat customers, and overall store performance to support business decisions.
